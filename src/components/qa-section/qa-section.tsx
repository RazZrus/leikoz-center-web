    ...
    <>
        ...
        <Accordion>
            ...
            <Details>
                ...
                Мы собрали информацию о костном мозге <TextLink href="https://portal.leikozu.net/articles/donorstvo-kostnogo-mozga-vse-chto-nuzhno-znat/">здесь</TextLink>, чтобы вы смогли лучше ознакомиться со всей информацией.
            </Details>
            <Details>
                <Summary>
                ...
                На территории РФ существует несколько регистров костного мозга. Регистрироваться нужно всего лишь один раз и в одном реестре, чтобы не создалось путаницы в базе данных. Мы предлагаем Вам зарегистрироваться через <TextLink href="https://www.gosuslugi.ru/606630/1/form">Госуслуги</TextLink> онлайн.
            </Details>
            <Details>
                <Summary>
                ...
                <p>
                    1) Процедура афереза: забора клеток из венозной крови 90-95% случаев от всех донаций
